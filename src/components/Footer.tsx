...
function WhatsAppIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path d="M12 2C6.49 2 2 6.49 2 12c0 1.8.48 3.54 1.39 5.06L2 22l5.11-1.34A9.96 9.96 0 0 0 12 22c5.52 0 10-4.49 10-10S17.52 2 12 2Zm4.91 14.36c-.19.53-1.12 1.02-1.53 1.08-.41.06-.94.08-1.53-.12-.34-.12-.78-.28-1.34-.5-2.32-.96-3.83-3.21-3.95-3.36-.12-.15-.95-1.18-.95-2.25s.55-1.58.75-1.8c.2-.22.44-.28.58-.28h.42c.14 0 .33-.05.5.39.17.44.58 1.53.63 1.64.05.11.08.25.02.39-.06.14-.09.23-.2.35-.1.12-.23.26-.33.37-.11.11-.22.24-.09.46.13.22.56.94 1.2 1.52.83.74 1.52.96 1.76 1.07.23.11.36.09.51-.06.14-.16.57-.64.73-.87.16-.24.31-.2.52-.08.21.12 1.36.63 1.58.75.22.11.37.16.43.26.06.1.06.56-.16 1.15Z" />
    </svg>
  )
}
...
export default function Footer({ compact = false, hideUnverifiedContact = false }: { compact?: boolean; hideUnverifiedContact?: boolean }) {
  ...
  const visibleSocials = hideUnverifiedContact
    ...
    : FOOTER_SOCIAL
  const visibleFooterLinks = FOOTER_LINKS.filter((link) => link.label !== "About Us")
