    ...
    >
      <div className="mx-auto grid grid-cols-1 divide-y md:grid-cols-2 md:items-center md:divide-x md:divide-y-0" style={{ maxWidth: "1120px", borderColor: "rgba(27,27,27,0.16)" }}>
        <div className="location-item flex flex-col items-center px-4 pb-10 text-center md:px-12 md:pb-0">
          ...
          >
            <span className="block">OUR FIRST MULTI-SPORTS</span>
            <span className="block">CLUB IS COMING TO DUBAI.</span>
          </h2>
          <p
            className="mt-3 max-w-[350px]"
        ...
        <div className="location-item flex flex-col items-center px-4 pt-10 text-center md:px-12 md:pt-0">
          ...
          <Link
            ...
            className="inline-flex items-center justify-center px-6 py-3 text-sm tracking-[0.08em] transition-colors hover:bg-[var(--color-black)]"
            style={{
              fontFamily: "var(--font-body)",
              fontWeight: "var(--font-weight-bold)",
              color: "var(--color-white)",
              // Existing approved deep-green value from the codebase (WhyYoungIcons.tsx DEEP_GREEN) —
              // no --color-deep-green token exists in tokens.css, so reusing the verified literal hex.
              backgroundColor: "#04291A",
              textDecoration: "none",
              minWidth: "230px",
            }}
          >
