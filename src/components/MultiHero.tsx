...
export default function MultiHero() {
  ...
  return (
    ...
    >
      <Image src={MULTI_HERO.image} alt="" fill priority sizes="100vw" className="object-cover" />
      ...
      <div className="relative max-w-4xl w-full mx-auto text-center" style={{ zIndex: 2 }}>
        ...
        >
          {MULTI_HERO.smallHeading}
        </p>

        <h1
          aria-label={`${MULTI_HERO.headingWhite} ${MULTI_HERO.headingGreen}`}
